const renderItem = async () => {
    ...
    if (item) {
        ...
        //console.log(item.submittedby)
        //console.log(item.submittedOn)
        document.getElementById('submittedOn').textContent = 'Posted on: ' + item.submittedon.split(0,10)+" "+item.submittedon.split(11,16)
